        ...
        >
          {BENEFITS.map((item) => (
            <motion.article
              ...
              className="rounded-[32px] bg-white px-5 2xl:px-7 py-8 shadow-[0px_4px_12px_0px_rgba(0,0,0,0.15)]"
            >
              ...
              <h3 className="mt-1 text-xl font-bold leading-[28px] text-[#070707] 2xl:text-2xl 2xl:leading-[32px]">
                {item.title}
              </h3>
              <p className="mt-4 text-sm leading-[20px] text-[#474747] 2xl:text-base 2xl:leading-[22px]">
                {item.body}
              </p>
            </motion.article>
          ))}
