      ...
      <div className="section-content">
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-2 lg:gap-3">
            ...
            />
            <h2 className="text-xl leading-[28px] font-bold uppercase text-[#002b5b] lg:text-3xl lg:leading-[42px]">
          ...
          <Link
            href="/jobs"
            className="inline-flex items-center gap-1 text-sm leading-[20px] font-bold text-[#002b5b] transition duration-200 hover:scale-105 hover:text-[#0C71C7] lg:gap-1 lg:text-lg lg:leading-[25px]"
          >
            Xem tất cả
        ...
        <div className="mt-6 flex gap-3 overflow-x-auto pb-1 lg:mt-10 lg:grid lg:grid-cols-4 lg:gap-5 lg:overflow-visible lg:pb-0">
          {RELATED_JOBS.map((job) => (
            ...
            >
              <div className="inline-flex rounded bg-[#d9e6f2] px-2 py-1 text-xs font-semibold leading-[1.4] text-[#707070] lg:text-xs">
                {job.tag}
              </div>
              <h3 className="mt-2 text-lg leading-[26px] font-bold text-[#292929]">
                {job.title}
              </h3>
              <div className="mt-3 flex items-center gap-2 text-sm leading-[22px] text-[#474747] lg:text-base lg:leading-[26px]">
