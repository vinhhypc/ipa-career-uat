...
export default function EpicSection() {
  return (
    <section
      className="section-padding relative overflow-hidden !py-10 md:!py-14 md:!pt-10 lg:!py-20 lg:px-12 xl:!py-24 xl:px-16"
    ...
    >
      ...
      <div className="section-content relative z-10 flex flex-col items-center gap-8 md:gap-[52px]">
        ...
        >
          ...
          <h2 className="text-2xl font-extrabold uppercase leading-[34px] tracking-[0.5px] text-[#292929] sm:text-3xl sm:leading-[40px] md:leading-[48px] md:tracking-[0.9px] lg:text-3xl lg:leading-[60px] lg:tracking-[1px] xl:text-4xl xl:leading-[66px] 2xl:text-5xl 2xl:leading-[72px]">
        ...
        >
          {EPIC_CARDS.map((item) => (
            <motion.article
              ...
              className="flex flex-col gap-4 rounded-[24px] bg-white px-5 py-5 shadow-[0_4px_6px_rgba(0,0,0,0.15)] sm:rounded-[28px] sm:px-6 sm:py-6 md:gap-8 md:rounded-[32px] md:px-7 md:py-7 xl:gap-12 xl:py-8"
            >
              <p className="text-6xl font-extrabold leading-[56px] text-[#002b5b] md:text-6xl md:leading-[64px] lg:text-7xl lg:leading-[80px]">
                {item.key}
              </p>
              <div className="flex flex-col gap-2.5 md:gap-3 xl:gap-4">
                <h3 className="text-lg font-bold leading-[26px] text-[#070707] md:text-xl md:leading-[28px] xl:text-2xl lg:leading-[32px]">
                  {item.title}
                </h3>
                <p className="text-xs font-normal leading-[21px] text-[#474747] sm:text-sm sm:leading-[22px] md:text-sm md:leading-[22px] xl:text-base">
                  {item.desc}
                </p>
              </div>
            </motion.article>
