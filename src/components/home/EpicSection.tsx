...
export default function EpicSection() {
  return (
    <section
      className="section-padding relative overflow-hidden max-md:py-10! md:py-20! md:pt-10!"
    ...
    >
      ...
      <div className="section-content relative z-10 flex flex-col items-center gap-8 md:gap-[52px]">
        ...
        >
          ...
          <h2 className="text-[24px] font-extrabold uppercase leading-[34px] tracking-[0.5px] text-[#292929] md:text-[40px] md:leading-[60px] md:tracking-[1px]">
          ...
          {EPIC_CARDS.map((item) => (
            ...
            >
              ...
              <div className="flex flex-col gap-2.5 md:gap-4">
                <h3 className="text-[18px] font-bold leading-[26px] text-[#070707] md:text-[24px] md:leading-[32px]">
                  {item.title}
                </h3>
                <p className="text-[13px] font-normal leading-[21px] text-[#474747] md:text-sm md:leading-[22px]">
                  {item.desc}
                </p>
              </div>
            </motion.article>
