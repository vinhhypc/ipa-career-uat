      ...
      <div className="section-content relative z-10">
        <div className="flex w-full flex-col gap-0 md:gap-10 lg:flex-row lg:items-center lg:justify-between">
          ...
          >
            ...
            <h2 className="mt-2 text-[32px] font-bold leading-tight tracking-[0.8px] text-[#292929] uppercase md:text-[40px] md:leading-[60px]">
              IPAG -
              <br />
              Capability Bank
            </h2>
          ...
          <motion.div
            className="flex w-full min-w-0 flex-col items-center gap-0 lg:min-w-0 lg:flex-1 lg:flex-row lg:items-center lg:gap-10"
          ...
          >
            ...
            >
              {WHY_IPAG_ITEMS.map((item, index) => (
                ...
                >
                  <div className="flex w-full min-w-0 items-start gap-3 lg:gap-4">
                    <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-white p-1 shadow-[0px_4px_6px_rgba(0,0,0,0.15)] lg:size-20 lg:bg-transparent lg:p-0 lg:shadow-none">
                      <div className="relative flex size-10 shrink-0 items-center justify-center overflow-hidden rounded-full bg-[linear-gradient(181.96deg,#fffaf0_85.9%,#ffc987_185.9%)] lg:size-20 lg:bg-none lg:overflow-visible">
                        <Image
                          ...
                          width={80}
                          height={80}
                          className="pointer-events-none block object-contain object-center max-lg:absolute max-lg:left-1/2 max-lg:top-1/2 max-lg:size-10 max-lg:origin-center max-lg:transform-[translate(-50%,calc(-50%+0.25rem))_scale(2.38)] lg:relative lg:left-auto lg:top-auto lg:size-full lg:transform-none lg:object-cover"
                        />
                      </div>
                    </div>
                    <div className="flex min-w-0 flex-1 flex-col gap-1">
                      <h3 className="text-base font-bold leading-[26px] text-[#292929] lg:text-[18px]">
                        {item.title}
                      </h3>
                      ...
                      <p
                        className={
                          index === 0
                            ? 'text-sm leading-5 text-[#474747] lg:text-[16px] lg:leading-[22px]'
                            : 'text-sm leading-[22px] text-[#474747] lg:text-[16px]'
                        }
                      >
                        {item.desc}
                      </p>
